...
Cost: $${funcs.costCalc(upgrades[121].price, data.upgrades[121])}
Boost: +$${upgrades[121].boost}/hr
ID: 121\n
**New Furniture**  \`(${data.upgrades[122]}/13)\`
Cost: $${funcs.costCalc(upgrades[122].price, data.upgrades[122])}
Boost: +$${upgrades[122].boost}/hr
ID: 122\n
**Better Appliances**  \`(${data.upgrades[123]}/15)\`
Cost: $${funcs.costCalc(upgrades[123].price, data.upgrades[123])}
Boost: +$${upgrades[123].boost}/hr
ID: 123\n
**Nicer Batchrooms**  \`(${data.upgrades[124]}/12)\`
Cost: $${funcs.costCalc(upgrades[124].price, data.upgrades[124])}
Boost: +$${upgrades[124].boost}/hr
ID: 124\n
**Billboard**  \`(${data.upgrades[125]}/15)\`
Cost: $${funcs.costCalc(upgrades[125].price, data.upgrades[125])}
Boost: +$${upgrades[125].boost}/hr
ID: 125\n
**Cooler Tip Jar**  \`(${data.upgrades[126]}/13)\`
Cost: $${funcs.costCalc(upgrades[126].price, data.upgrades[126])}
